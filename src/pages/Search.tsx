...
const Search: FunctionComponent<SearchProps> = () => {
  ...
  return (
    <>
      {!query && <Title value="Search | Star+" />}
      {query && <Title value={`Search: ${query} | Star+`} />}
      ...
      <div className="flex md:hidden justify-between items-center px-5 my-5">
        <Link to="/" className="flex gap-2 items-center">
          ...
          <p className="text-xl text-white font-medium tracking-wider uppercase">
            Star<span className="text-primary">...+</span>
          </p>
        </Link>
      ...
      <div className="flex min-h-screen flex-col-reverse md:flex-row">
        ...
        <div className="flex-grow">
          ...
          {!query && (
            <div className="mt-[250px] flex item-center justify-center ">
              
                  <a
            href="https://github.com/Nibezak"
            target="_blank"
            rel="noreferrer"
            className=" object-cover rounded-xl hover:text-[#6e5494] transition duration-300"
          >
